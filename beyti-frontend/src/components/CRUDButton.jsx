...
const CRUDButton = ({
  ...
  const variantStyles = {
    ...
    success: 'bg-success-btn text-sage-100 hover:bg-success-text',

    // Error: bg-error-btn, text-sage-100
    error: 'bg-error-btn text-sage-100 hover:bg-error-text',

    // Danger: bg-danger-btn, text-charcoal-600
    danger: 'bg-danger-btn text-charcoal-600 hover:bg-danger-text',

    // Neutral: bg-cream-100, text-charcoal-600
    neutral: 'bg-cream-100 text-charcoal-600 hover:bg-cream-200',

    // Outline: no bg, text-charcoal-600, stroke-charcoal-400
    outline: 'bg-transparent text-charcoal-600 border-2 border-charcoal-400 hover:bg-cream-50',
  };
